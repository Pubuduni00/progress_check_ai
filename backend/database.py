...
#             # Some sessions might have tempWorkUpdateId, others might have been moved to workUpdateId
...
#             logger.info(f"Cleaned up {deleted_sessions_count} associated followup sessions")
#         else:
